...
func (r *RequestOptions) cloneHeader() http.Header {
	...
	headers.Set("X-Fern-SDK-Name", "github.com/crylabsorg/suward-sdk-go")
	headers.Set("X-Fern-SDK-Version", "v0.0.30")
	headers.Set("User-Agent", "github.com/crylabsorg/suward-sdk-go/0.0.30")
	return headers
}
